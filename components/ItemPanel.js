...
export default function ItemPanel({ product }) {
  console.log(product);
  return (
    <div className="h-1/5  bg-white border-slate-500 border-8	flex">
      ...
      <div className="p-3 rounded-md relative top-1/3 h-1/3 bg-slate-900 text-white text-xl flex items-center ml-auto mr-auto">
